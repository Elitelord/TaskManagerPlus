...
pub struct RawPerformanceSnapshot {
    ...
    pub gpu_usage_percent: f64,
    pub gpu_engine_sum_percent: f64,
    pub gpu_usage_3d_percent: f64,
    pub gpu_usage_compute_percent: f64,
...
pub fn load_performance_snapshot() -> Result<PerformanceSnapshot, String> {
    ...
    unsafe {
        ...
        Ok(PerformanceSnapshot {
            ...
            gpu_usage_percent: info.gpu_usage_percent,
            gpu_engine_sum_percent: info.gpu_engine_sum_percent,
            gpu_usage_3d_percent: info.gpu_usage_3d_percent,
            gpu_usage_compute_percent: info.gpu_usage_compute_percent,
